...
public class Expense {
	...
	@Id
	@TableGenerator(name = "exp_seq_gen", table = "exp_seq_tab", pkColumnName = "exp_pk" , valueColumnName = "exp_val", pkColumnValue = "exp", initialValue = 100, allocationSize = 1) // 4th type
